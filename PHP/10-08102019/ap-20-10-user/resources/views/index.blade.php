        ...
        <div class="col-12">
            <div class="d-flex flex-row algin-items-center">
                ...
                <div class="col-10 pl-0">
                   <h1 class="text-center font-weight-bold text-uppercase ">Bài Tập Về Nhà Laravel</h1>
                </div>
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td>{{$user->name}}</td>
                        <td>{{$user->email}}</td>
                        <td>{{$user->passwoord}}</td>
                        <td class="d-flex align-items-center justify-content-around">
                            <form action="./show.blade.php" method="get">
                            ...
                            <form action="" method="post">
                                <input type="hidden" name="_method" value="delete"> <input type="hidden" name="_token" value="ZhpdjI2qoML2wzxppRaTl0aeQ64MpUz1LBVHxMcn">
